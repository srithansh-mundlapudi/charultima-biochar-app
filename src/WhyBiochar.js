      ...
      <div className="space-y-8">
        <section className="bg-white rounded-lg p-6 shadow-sm">
          <div>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Nitrogen is one of the most abundant elements in our atmosphere
              and essential for life on Earth. While it plays a crucial role in
              DNA and plant growth, making it critical for food production,
              maintaining the right balance is challenging. Both insufficient
              and excessive nitrogen levels can be detrimental to environmental
              and human health.
            </p>
        ...
        <section className="bg-white rounded-lg p-6 shadow-sm">
          ...
          <ul className="list-disc ml-6 mt-2 space-y-2 text-gray-700">
            ...
            <li>
              Formation of dangerous particulates from agricultural ammonia
              emissions
            </li>
        ...
        <section className="bg-white rounded-lg p-6 shadow-sm">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Our biochar classification system helps farmers and agricultural
            professionals:
          </p>
          <ul className="list-disc ml-6 mt-2 space-y-2 text-gray-700">
            <li>
              Identify optimal biochar qualities for specific soil conditions
            </li>
            ...
            <li>
              Contribute to long-term soil health and environmental protection
            </li>
          </ul>
        </section>
      </div>
