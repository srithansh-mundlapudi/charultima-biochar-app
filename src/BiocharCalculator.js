...
export const getBiocharRecommendations = async (farmData) => {
  const { cellLength, cellWidth, soilType, cropType, nitrogenLevels } = farmData;
  ...
  const recommendations = calculateBiochar(nitrogenLevels, recommendedNitrogen, forecast, cellArea);
